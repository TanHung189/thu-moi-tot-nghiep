  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="w-12 h-12 flex items-center justify-center bg-white border border-[#bca374] shadow-sm text-[#bca374] hover:bg-[#bca374] hover:text-white transition-colors rounded-none"
